...
public class LobberZombieEntity extends ZombieEntity implements RangedAttackMob {
	...
	protected static final TrackedData<Boolean> IS_ATTACKING_RANGED = DataTracker.registerData(LobberZombieEntity.class, TrackedDataHandlerRegistry.BOOLEAN);
	...
	@Override protected SoundEvent getAmbientSound() { return LobberZombiesMod.ENTITY_LOBBER_ZOMBIE_AMBIENT; }
	@Override protected SoundEvent getHurtSound(DamageSource source) { return LobberZombiesMod.ENTITY_LOBBER_ZOMBIE_HURT; }
	@Override protected SoundEvent getDeathSound() { return LobberZombiesMod.ENTITY_LOBBER_ZOMBIE_DEATH; }
	@Override protected SoundEvent getStepSound() { return LobberZombiesMod.ENTITY_LOBBER_ZOMBIE_STEP; }

	protected static class ThrowerAttackGoal extends MeleeAttackGoal {
		public final LobberZombieEntity entity;
		public final float range;
		public int ticks;
		public ThrowerAttackGoal(LobberZombieEntity entity, double speed, boolean pauseWhenMobIdle, float range) {
	...
	protected static class ThrowerRangedAttackGoal extends Goal {
		private final LobberZombieEntity entity;
		...
		public ThrowerRangedAttackGoal(LobberZombieEntity entity, double mobSpeed, int minIntervalTicks, int maxIntervalTicks, float maxShootRange, float range) {
